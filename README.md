...
[![Coverage Status](https://coveralls.io/repos/github/jplu/stanfordNLPRESTAPI/badge.svg?branch=develop)](https://coveralls.io/github/jplu/stanfordNLPRESTAPI?branch=master)
...
```
usage: java -jar stanfordNLPRESTAPI-2.0.1-SNAPSHOT.jar
...
```
usage: java -jar stanfordNLPRESTAPI-2.0.1-SNAPSHOT
...
```
docker run -d -p 7000:7000 -p 7001:7001 -v $PWD/models:/maven/models -v $PWD/conf:/maven/conf jplu/stanford-nlp-rest-api:2.0.1-SNAPSHOT
```
