...
MAINTAINER Julien Plu

ADD target/stanfordNLPRESTAPI-1.0.1.jar /data/stanfordNLPRESTAPI-1.0.1.jar

ADD conf/config.yaml /data/config.yaml

CMD java -jar /data/stanfordNLPRESTAPI-1.0.1.jar server /data/config.yaml
